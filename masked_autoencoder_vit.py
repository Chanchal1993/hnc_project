...
from utils.pos_embed import get_2d_sincos_pos_embed  # from MAE repo utils

class MaskedAutoencoderViT(nn.Module):
    """ Masked Autoencoder with VisionTransformer backbone (facebookresearch/mae style) """
    def __init__(
        ...
        # Fixed (non-trainable) sinusoidal positional embedding
    ...
    def initialize_weights(self):
        ...
        # Initialize patch embedding projection weights
